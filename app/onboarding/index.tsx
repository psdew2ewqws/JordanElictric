  ...
  return (
    <View style={styles.screen}>
      ...
      >
        ...
        >
          <Text style={[styles.welcomeText, { fontFamily: fonts.bold, fontSize: sz(22) }]}>
            {t('welcome')}, Ahmad 👋
          </Text>
          ...
          <View style={styles.cpaBadge}>
            <Ionicons name="shield-checkmark" size={14} color="#94A9B8" />
...
const styles = StyleSheet.create({
  ...
  logoAr: { fontSize: 30, color: '#fff', letterSpacing: -0.5 },
  logoEn: { fontSize: 12, color: 'rgba(255,255,255,0.4)', marginTop: 2 },

  // Form
  formWrap: { flex: 1 },
  formContent: { paddingHorizontal: 24, paddingTop: 28, paddingBottom: 40 },
  welcomeText: { color: '#0C1E2D', letterSpacing: -0.3 },
  setupText: { color: '#6B8499', marginTop: 4, marginBottom: 28 },

  fieldLabel: { color: '#1B4965', marginBottom: 6 },
  fieldHint: { color: '#6B8499', marginBottom: 12, lineHeight: 18 },
  ...
  arabicHint: { fontSize: 10, color: '#94A9B8', marginTop: 6, writingDirection: 'ltr' },
  ...
  fakeBillHeader: { fontSize: 9, color: '#6B8499', textAlign: 'center', marginBottom: 10 },
  fakeBillRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  fakeBillLabel: { fontSize: 10, color: '#6B8499' },
  fakeBillHighlight: {
  ...
  modalDesc: { fontSize: 13, color: '#6B8499', lineHeight: 19, marginBottom: 12 },
  modalTip: {
  ...
  modalContact: { fontSize: 11, color: '#94A9B8', marginBottom: 14 },
  modalClose: {
