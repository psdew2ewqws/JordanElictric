...
const styles = StyleSheet.create({
  ...
  modalIntro: { fontSize: 13, color: '#0C1E2D', lineHeight: 20, marginBottom: 14 },
  ...
  modalTierDesc: { fontSize: 12, color: '#0C1E2D', lineHeight: 18 },
  modalExample: { backgroundColor: '#F2F5F7', borderRadius: 10, padding: 12, marginTop: 8 },
  modalExampleTitle: { fontSize: 13, color: '#0C1E2D', marginBottom: 4 },
  modalExampleBody: { fontSize: 12, color: '#0C1E2D', lineHeight: 18 },
  ...
  modalTipText: { flex: 1, fontSize: 12, color: '#0C1E2D', lineHeight: 18 },
